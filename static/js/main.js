...
async function submitAction() {
    ...
    const output = document.getElementById('outputContent');
    appendTranscriptLine(output, 'You', input);
    ...
    try {
        ...
        if (!res.ok || result.error) {
            ...
            appendTranscriptLine(output, 'Error', result.error || `Request failed with status ${res.status}`, 'error-line');
        ...
        appendTranscriptLine(output, 'Error', e.message, 'error-line');
    }
}
