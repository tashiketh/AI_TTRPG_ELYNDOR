...
class EnhancedSocialCalculator:
    ...
    def resolve_social_interaction(self, npc_id: str, interaction_type: str,
                                 player_action: str, difficulty_class: int = 50) -> Dict[str, Any]:
        ...
        # Generate narrative
        narrative_context = self._prepare_narrative_context(npc_data, social_result, player_action)
        narrative = self.api.call_api("narrative_generation", narrative_context)

        # Generate NPC dialogue
        dialogue_context = self._prepare_dialogue_context(npc_data, social_result)
    ...
    def _prepare_dialogue_context(self, npc_data: Dict, social_result: Dict) -> Dict[str, Any]:
